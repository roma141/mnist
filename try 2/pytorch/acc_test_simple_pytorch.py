...
# features = scipy.io.loadmat("pytorch_loss-0.1955_acc-94.47") # mean 0.1307 std 0.3081
# features = scipy.io.loadmat("pytorch_loss-0.3578_acc-90.06") # no nomalization
features = scipy.io.loadmat("pytorch_loss-0.2496_acc-93.0") ## mean 0.5 std 0.5
# print features
...
x_2 = example["image"]
# x_2 = (x_2 - 127.5) / 74.045 # normalize with mean and std
# x_2 = (x_2 - 127.5) / 128 # normalize with mean and std
# x_2 = (x_2 - 0.1307) / 0.3081 # normalize with mean and std
# x_2 = tf.nn.batch_normalization(x_2,mean=0.1307,variance=0.3081, offset=None, scale=None, variance_epsilon=1e-10)
# x_2 = (x_2 * 127) + 128.0 # to unnormalize
...
W_fc1_2 = weight_variable_2([320, hidden])
...
h_pool1_2 = tf.nn.relu(max_pool_2x2(conv2d(x_r, W_conv1_2) + b_conv1_2))
...
h_pool2_2 = tf.nn.relu(max_pool_2x2(conv2d(h_pool1_2, W_conv2_2) + b_conv2_2))
...
# h_pool_last_flat_2 = tf.reshape(h_pool2_2, [-1, last_img_size * last_img_size  * cv_all_channels * 2])
h_pool_last_flat_2 = tf.reshape(h_pool2_2, [-1, 320])

h_fc1_2 = tf.nn.relu(tf.matmul(h_pool_last_flat_2, W_fc1_2) + b_fc1_2)
pred_2 = tf.nn.softmax(tf.matmul(h_fc1_2, W_fc2_2) + b_fc2_2)
# pred_2 = tf.nn.log_softmax(tf.matmul(h_fc1_2, W_fc2_2) + b_fc2_2)
...
with tf.Session() as sess:
	...
	sess.run(init)
	sess.run([
	    W_conv1_2.assign(features["conv1.weight"].T),
	    b_conv1_2.assign(features["conv1.bias"][0].T),
	    W_conv2_2.assign(features["conv2.weight"].T),
	    b_conv2_2.assign(features["conv2.bias"][0].T),
	    ...
	    W_fc1_2.assign(features["fc1.weight"].T),
	    b_fc1_2.assign(features["fc1.bias"][0].T),
	    W_fc2_2.assign(features["fc2.weight"].T),
	    b_fc2_2.assign(features["fc2.bias"][0].T)
    ])
