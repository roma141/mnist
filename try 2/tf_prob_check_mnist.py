...
with tf.Session() as sess:
	...
	best1 = prob1 - prob2
	best2 = np.absolute(prob1) - np.absolute(prob2)

	print
	print "best1 shape:" , best1.shape
	print "best1-1:", np.sum(best1)
	print "best1-2:", np.sum(np.absolute(best1))

	print
	print "best2 shape:" , best2.shape
	print "best2-1:", np.sum(best2)
	print "best2-2:", np.sum(np.absolute(best2))
