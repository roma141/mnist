...
features = scipy.io.loadmat("pytorch_loss-0.0529_acc-98.3")
print features
parameters = param()
...
with tf.Session() as sess:
	...
	sess.run(init)
	sess.run([
	    W_conv1_2.assign(features["conv1.weight"]),
	    b_conv1_2.assign(features["conv1.bias"][0]),
	    W_conv2_2.assign(features["conv2.weight"]),
	    b_conv2_2.assign(features["conv2.bias"][0]),
	    ...
	    W_fc1_2.assign(features["fc1.weight"]),
	    b_fc1_2.assign(features["fc1.bias"][0]),
	    W_fc2_2.assign(features["fc2.weight"]),
	    b_fc2_2.assign(features["fc2.bias"][0])
    ])
